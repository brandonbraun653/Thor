...
namespace Thor::LLD::UART
{
  ...
  struct RegisterMap
  {
    volatile Reg32_t SR;   /**< UART Status register,                   Address offset: 0x00 */
    volatile Reg32_t DR;   /**< UART Data register,                     Address offset: 0x04 */
    volatile Reg32_t BRR;  /**< UART Baud rate register,                Address offset: 0x08 */
    volatile Reg32_t CR1;  /**< UART Control register 1,                Address offset: 0x0C */
    volatile Reg32_t CR2;  /**< UART Control register 2,                Address offset: 0x10 */
    volatile Reg32_t CR3;  /**< UART Control register 3,                Address offset: 0x14 */
    volatile Reg32_t GTPR; /**< UART Guard time and prescaler register, Address offset: 0x18 */
  };
