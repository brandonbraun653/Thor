...
namespace Thor::LLD::CAN
{
  ...
  REG_ACCESSOR( RegisterMap, MCR, MCR_NART_Msk, NART, BIT_ACCESS_RW );
  ...
  REG_ACCESSOR( RegisterMap, TSR, TSR_ABRQ0_Msk, ABRQ0, BIT_ACCESS_RS );
  ...
  REG_ACCESSOR( RegisterMap, TSR, TSR_ABRQ1_Msk, ABRQ1, BIT_ACCESS_RS );
  ...
  REG_ACCESSOR( RegisterMap, TSR, TSR_ABRQ2_Msk, ABRQ2, BIT_ACCESS_RS );
