...
namespace Thor::LLD::ADC
{
  ...
  public:
    ...
    /**
     *  Synchronizes latest dataset generated by the DMA engine into the HLD queues
     *  @return void
     */
    virtual void syncSequence() = 0;
  };
  ...
  private:
    ...
    bool mDMAPaused;                      /**< Track if the DMA based sequence is paused */
