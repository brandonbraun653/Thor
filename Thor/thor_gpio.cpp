...
// STM32F4 PDF: RM0390 pg.143
  ...
  PinNum convertPinNum( const uint8_t num )
  {
  ...
  PinPort convertPort( const Chimera::GPIO::Port port )
  {
  ...
  PinMode convertDrive( const Chimera::GPIO::Drive drive )
  {
  ...
  PinPull convertPull( const Chimera::GPIO::Pull pull )
  {
  ...
  Initializer convertPinInit( const Chimera::GPIO::PinInit &pin )
  {
    Initializer cfg;
