...
namespace Thor
{
  ...
  namespace Peripheral
  {
    ...
    namespace UART
    {
       ...
       *		  read on a class object up to an internal buffer limit defined by Thor::Serial::UART_BUFFER_SIZE
       **/
      class UARTClass : public Thor::Serial::SerialInterface
      {
      public:
        /**
         ...
         *	@return	Thor::Status
         */
        Thor::Status begin( const uint32_t baud                    = 115200u,
                                         const Thor::Modes tx_mode = Thor::Modes::BLOCKING,
         ...
         */
        Thor::Status read( uint8_t *const buff, const size_t length ) override;
      ...
      public:
         ...
         **/
        static std::shared_ptr<UARTClass> create( const uint8_t channel,
                                                  const Thor::Serial::SerialPins &pinConfig );
        ~UARTClass();
