    ...
    namespace SPI
    {
      ...
      public:
        ...
        Chimera::SPI::Status writeBytes( const uint8_t *const txBuffer, size_t length, const bool &disableCS = true,
                                         const bool &autoRelease = false, uint32_t timeoutMS = 10 ) final override;
        ...
        Chimera::SPI::Status readWriteBytes( const uint8_t *const txBuffer, uint8_t *const rxBuffer, size_t length,
                                             ...
                                             uint32_t timeoutMS = 10 ) final override;
...
#if defined( USING_FREERTOS )
        Chimera::SPI::Status attachEventWakeup( const Chimera::FreeRTOS::SPIEvent &event,
                                                const SemaphoreHandle_t *const semphr ) final override;
