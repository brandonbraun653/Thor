...
namespace Thor
{
  ...
  namespace Peripheral
  {
    ...
    namespace Serial
    {
       ...
       *   away from the specific UART and USART peripherals so that the user only has to call 'SerialClass(1)' or
       *'SerialClass(x)' to generate a serial object quickly without having to worry about the underlying hardware type.
       */
      class SerialClass : public Thor::Threading::Lockable, public Thor::Serial::SerialInterface
      {
      public:
        SerialClass( const uint8_t channel );
        SerialClass( const uint8_t channel, const Thor::Serial::SerialPins &pinConfig );
        ~SerialClass() = default;
         ...
         *	@return	Thor::Status
         */
        Thor::Status begin( const uint32_t baud, const Thor::Modes tx_mode,
                                         const Thor::Modes rx_mode ) override;
        ...
        Thor::Status setMode( const Thor::SubPeripheral periph,
                                           const Thor::Modes mode ) override;
         ...
         */
        Thor::Status read( uint8_t *const buffer, const size_t length ) override;
      ...
      private:
        ...
        std::shared_ptr<Thor::Serial::SerialInterface> serialObject;
      };
 ...
 */
      ...
      public:
        ...
        Chimera::Serial::Status begin( const uint32_t baud, const Chimera::Serial::Modes txMode,
                                       const Chimera::Serial::Modes rxMode ) final override;

        Chimera::Serial::Status setBaud( const uint32_t baud ) final override;

        Chimera::Serial::Status setMode( const Chimera::Serial::SubPeripheral periph,
        ...
        Chimera::Serial::Status attachEventNotifier( const Chimera::Serial::Event event,
                                                     volatile bool *const notifier ) final override;

        Chimera::Serial::Status removeEventNotifier( const Chimera::Serial::Event event,
                                                     volatile bool *const notifier ) final override;
