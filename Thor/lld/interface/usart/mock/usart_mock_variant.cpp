...
namespace Thor::LLD::USART
{
  ...
  Chimera::Container::LightFlatMap<Chimera::Serial::Channel, RegisterMap *> ChannelToInstance{
    { Chimera::Serial::Channel::USART1, &USART1_PERIPH },
    { Chimera::Serial::Channel::USART2, &USART2_PERIPH },
    { Chimera::Serial::Channel::USART3, &USART3_PERIPH },
    { Chimera::Serial::Channel::USART4, &USART4_PERIPH }
  };
