...
#define EXC_RETURN_THREAD_PSP_FPU \
  ...
  __STATIC_INLINE uint32_t __NVIC_GetEnableIRQ( IRQn_Type IRQn )
  {
    ...
    {
      return ( ( uint32_t )(
          ( ( NVIC->ISER[ ( ( ( uint32_t )IRQn ) >> 5UL ) ] & ( 1UL << ( ( ( uint32_t )IRQn ) & 0x1FUL ) ) ) != 0UL ) ? 1UL
                                                                                                                      : 0UL ) );
    }
    else
    {
  ...
  __STATIC_INLINE uint32_t __NVIC_GetPendingIRQ( IRQn_Type IRQn )
  {
    ...
    {
      return ( ( uint32_t )(
          ( ( NVIC->ISPR[ ( ( ( uint32_t )IRQn ) >> 5UL ) ] & ( 1UL << ( ( ( uint32_t )IRQn ) & 0x1FUL ) ) ) != 0UL ) ? 1UL
                                                                                                                      : 0UL ) );
    }
    else
    {
  ...
  __STATIC_INLINE uint32_t __NVIC_GetActive( IRQn_Type IRQn )
  {
    ...
    {
      return ( ( uint32_t )(
          ( ( NVIC->IABR[ ( ( ( uint32_t )IRQn ) >> 5UL ) ] & ( 1UL << ( ( ( uint32_t )IRQn ) & 0x1FUL ) ) ) != 0UL ) ? 1UL
                                                                                                                      : 0UL ) );
    }
    else
    {
