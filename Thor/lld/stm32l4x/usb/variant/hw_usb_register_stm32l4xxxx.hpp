...
namespace Thor::LLD::USB
{
  ...
  static constexpr uint32_t ADDR0_TX_Msk = ( 0x7FFFUL << ADDR0_TX_ADDR0_TX_Pos );
  static constexpr uint32_t ADDR0_TX     = ADDR0_TX_ADDR0_TX_Msk;
  static constexpr uint32_t ADDR1_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR1_TX_Msk = ( 0x7FFFUL << ADDR1_TX_ADDR1_TX_Pos );
  static constexpr uint32_t ADDR1_TX     = ADDR1_TX_ADDR1_TX_Msk;
  static constexpr uint32_t ADDR2_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR2_TX_Msk = ( 0x7FFFUL << ADDR2_TX_ADDR2_TX_Pos );
  static constexpr uint32_t ADDR2_TX     = ADDR2_TX_ADDR2_TX_Msk;
  static constexpr uint32_t ADDR3_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR3_TX_Msk = ( 0x7FFFUL << ADDR3_TX_ADDR3_TX_Pos );
  static constexpr uint32_t ADDR3_TX     = ADDR3_TX_ADDR3_TX_Msk;
  static constexpr uint32_t ADDR4_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR4_TX_Msk = ( 0x7FFFUL << ADDR4_TX_ADDR4_TX_Pos );
  static constexpr uint32_t ADDR4_TX     = ADDR4_TX_ADDR4_TX_Msk;
  static constexpr uint32_t ADDR5_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR5_TX_Msk = ( 0x7FFFUL << ADDR5_TX_ADDR5_TX_Pos );
  static constexpr uint32_t ADDR5_TX     = ADDR5_TX_ADDR5_TX_Msk;
  static constexpr uint32_t ADDR6_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR6_TX_Msk = ( 0x7FFFUL << ADDR6_TX_ADDR6_TX_Pos );
  static constexpr uint32_t ADDR6_TX     = ADDR6_TX_ADDR6_TX_Msk;
  static constexpr uint32_t ADDR7_TX_Pos = ( 1U );
  static constexpr uint32_t ADDR7_TX_Msk = ( 0x7FFFUL << ADDR7_TX_ADDR7_TX_Pos );
  static constexpr uint32_t ADDR7_TX     = ADDR7_TX_ADDR7_TX_Msk;

  static constexpr uint32_t COUNT0_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT0_TX_Msk = ( 0x3FFUL << COUNT0_TX_COUNT0_TX_Pos );
  static constexpr uint32_t COUNT0_TX     = COUNT0_TX_COUNT0_TX_Msk;
  static constexpr uint32_t COUNT1_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT1_TX_Msk = ( 0x3FFUL << COUNT1_TX_COUNT1_TX_Pos );
  static constexpr uint32_t COUNT1_TX     = COUNT1_TX_COUNT1_TX_Msk;
  static constexpr uint32_t COUNT2_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT2_TX_Msk = ( 0x3FFUL << COUNT2_TX_COUNT2_TX_Pos );
  static constexpr uint32_t COUNT2_TX     = COUNT2_TX_COUNT2_TX_Msk;
  static constexpr uint32_t COUNT3_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT3_TX_Msk = ( 0x3FFUL << COUNT3_TX_COUNT3_TX_Pos );
  static constexpr uint32_t COUNT3_TX     = COUNT3_TX_COUNT3_TX_Msk;
  static constexpr uint32_t COUNT4_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT4_TX_Msk = ( 0x3FFUL << COUNT4_TX_COUNT4_TX_Pos );
  static constexpr uint32_t COUNT4_TX     = COUNT4_TX_COUNT4_TX_Msk;
  static constexpr uint32_t COUNT5_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT5_TX_Msk = ( 0x3FFUL << COUNT5_TX_COUNT5_TX_Pos );
  static constexpr uint32_t COUNT5_TX     = COUNT5_TX_COUNT5_TX_Msk;
  static constexpr uint32_t COUNT6_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT6_TX_Msk = ( 0x3FFUL << COUNT6_TX_COUNT6_TX_Pos );
  static constexpr uint32_t COUNT6_TX     = COUNT6_TX_COUNT6_TX_Msk;
  static constexpr uint32_t COUNT7_TX_Pos = ( 0U );
  static constexpr uint32_t COUNT7_TX_Msk = ( 0x3FFUL << COUNT7_TX_COUNT7_TX_Pos );
  static constexpr uint32_t COUNT7_TX     = COUNT7_TX_COUNT7_TX_Msk;
