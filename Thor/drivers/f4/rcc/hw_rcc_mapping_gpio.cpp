...
------------------------------------------------*/
   ...
   */
  const std::array<ClockEnableConfig, Thor::Driver::GPIO::NUM_GPIO_PERIPHS> ClockConfig_GPIO = {
    { /* GPIOA */
   ...
   */
  const std::array<ClockEnableLowPowerConfig, Thor::Driver::GPIO::NUM_GPIO_PERIPHS> ClockConfigLP_GPIO = {
    { /* GPIOA */
   ...
   */
  const std::array<PeripheralResetConfig, Thor::Driver::GPIO::NUM_GPIO_PERIPHS> ResetConfig_GPIO = {
    { /* GPIOA */
